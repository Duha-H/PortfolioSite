    ...
    return (
      <div className="page-content">
        ...
        <div className="slide-up">
          ...
          <p>You can find a bit more about my educational and professional backgrounds in my <a href={require('../assets/pdfs/Resume_Duha_Hassan_v3_default.pdf')} target="_blank" rel="noopener noreferrer">resume</a> if you're in a hurry!</p>
          ...
          <div className="about-section">
            ...
            <ul>
              ...
              <li>Outside of tech, I'm a bit of an <b>astronomy</b> nerd. Space is just too fascinating...what little we know of it is, atleast. Have a look at <a href="https://en.wikipedia.org/wiki/Superbubble">Superbubbles</a>!</li>
