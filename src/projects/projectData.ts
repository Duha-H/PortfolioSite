...
const projects: {[key: string]: ProjectItem} = {
  'traccio': {
    ...
    media: [
      ...
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610381572/portfolio_assets/traccio_0_hbb2tx.svg', altText: 'Traccio desktop dashboard screenshots'},
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610381749/portfolio_assets/traccio_2_gjogmj.svg', altText: 'Traccio desktop and mobile application view screenshot, showing an application status timeline and different information about a job application'},
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610381751/portfolio_assets/traccio_1_azol8p.svg', altText: 'Traccio full landing page screenshot'},
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610381750/portfolio_assets/traccio_3_edxvbb.svg', altText: 'Traccio dashboard and journey view mobile screenshots'},
    ],
  ...
  '3d-modeller': {
    ...
    media: [
      ...
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610382182/portfolio_assets/modeller_0_ey53lf.svg', altText: '3D Modeller demo screenshot'},
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610382193/portfolio_assets/modeller_group_oaexb8.svg', altText: '3D Modeller main view and customization view screenshots'},
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610382179/portfolio_assets/modeller_4_qjga1w.svg', altText: '3D Modeller light theme screenshot'},
    ],
  ...
  'terra-pizza': {
    ...
    media: [
      ...
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610382284/portfolio_assets/terra_pizza_1_hqyoei.svg', altText: 'Terra Pizza demo screenshot with logo'}, 
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610382285/portfolio_assets/terra_pizza_2_obtixh.svg', altText: 'Terra Pizza startup screen and in-game pizza order interface'}, 
      { content: 'https://res.cloudinary.com/djxztokzp/image/upload/v1610382284/portfolio_assets/terra_pizza_3_tl0xc0.svg', altText: 'Terra Pizza game demo screenshots'},
    ],
